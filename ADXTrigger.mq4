...
//+------------------------------------------------------------------+
double stoch_main = 0.0, stoch_signal = 0.0;
double adx = 0.0, adxp = 0.0, adxm = 0.0;
...
void OnTick()
{
   ...
   stoch_main = NormalizeDouble(iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, 0), Digits); 
   stoch_signal = NormalizeDouble(iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_SIGNAL, 0), Digits);
   adx = NormalizeDouble(iADX(NULL, 0, 24, PRICE_CLOSE, MODE_MAIN, 1), Digits);
   adxp = NormalizeDouble(iADX(NULL, 0, 24, PRICE_CLOSE, MODE_PLUSDI, 1), Digits);
   adxm = NormalizeDouble(iADX(NULL, 0, 24, PRICE_CLOSE, MODE_MINUSDI, 1), Digits);
